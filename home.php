...
<div class="content_container">
   <article class="article_define grid_square_up">
		...
		<article class="article_define grid_square_up over">
			<form class="articledesc" action="php/addtocart.php" method="">
				<section class="articleamount">
					<p class = "smallText">amount:  </p>
					<input class="amount_form" type="text" name="amount" value="0">
					<input class="amount_artnr" type="text" name="ArtNr" value="',$row['ArtikelNr'],'">

					<input class="add_btn"  name="" type="submit" value="Add"/>
				</section>
